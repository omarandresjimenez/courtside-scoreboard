...
umpiresRouter.post('/umpires', adminAuth, async (req, res) => {
...
umpiresRouter.get('/umpires', adminAuth, async (req, res) => {
...
umpiresRouter.delete('/umpires/:umpireId', adminAuth, async (req, res) => {
