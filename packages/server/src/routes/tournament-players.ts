 ...
 */
tournamentPlayersRouter.post('/tournament-players/import', adminAuth, async (req, res) => {
...
tournamentPlayersRouter.get('/tournament-players', adminAuth, async (req, res) => {
...
tournamentPlayersRouter.delete('/tournament-players/:playerId', adminAuth, async (req, res) => {
